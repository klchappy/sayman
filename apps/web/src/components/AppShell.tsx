...
const navItems: NavItem[] = [
  ...
  { to: '/stock', label: 'Stok Bakiyesi', icon: Package, group: 'Muhasebe' },
  { to: '/tax-calendar', label: 'Vergi Takvimi', icon: CalendarDays, group: 'Muhasebe' },
  ...
  { to: '/referans', label: 'TR Referans Veri', icon: Globe, group: 'Master Data' },
